Contained in this repository are two softwares: HLA3DB and RepPred. 
...
NOTE:
	  ...
	  dissimilar from  the template (dscore > 1.5) that model is not included for further process.
